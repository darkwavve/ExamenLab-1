                                    ...
                                    list<Personaje*>*personajes)
{
    ...
    SDL_Texture *textura = IMG_LoadTexture(renderer, "assets/personaje/mage/down1.png");
    SDL_QueryTexture(textura, NULL, NULL, &this->rectangulo.w, &this->rectangulo.h);
    texturas_down.push_back(textura);
    texturas_down.push_back(IMG_LoadTexture(renderer, "assets/personaje/mage/down2.png"));

    ataque.push_back(IMG_LoadTexture(renderer, "assets/personaje/mage/ataque.png"));

    texturas_up.push_back(IMG_LoadTexture(renderer, "assets/personaje/mage/up1.png"));
    texturas_up.push_back(IMG_LoadTexture(renderer, "assets/personaje/mage/up2.png"));

    texturas_left.push_back(IMG_LoadTexture(renderer, "assets/personaje/mage/left1.png"));
    texturas_left.push_back(IMG_LoadTexture(renderer, "assets/personaje/mage/left2.png"));

    texturas_right.push_back(IMG_LoadTexture(renderer, "assets/personaje/mage/right1.png"));
    texturas_right.push_back(IMG_LoadTexture(renderer, "assets/personaje/mage/right2.png"));
